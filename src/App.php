    ...
    public static function StartGame()
    {
        ...
        while (true) {
            ...
            if (count(GameController::getSunkShips(self::$enemyFleet, true)) == count(self::$enemyFleet)) {
                ...
                self::$console->println("~                                                                            ~");
                self::$console->println("~                                                                            ~");
                self::$console->println("~        __   __                                                             ~");
                self::$console->println("~        \ \ / /__  _   _    _____      ___ __                               ~");
                self::$console->println("~         \ V / _ \| | | |  / _ \ \ /\ / / '_ \                              ~");
                self::$console->println("~          | | (_) | |_| | | (_) \ V  V /| | | |                             ~");
                self::$console->println("~     _.   |_|\___/ \__,_|  \___/ \_/\_/ |_| |_|  _                          ~");
                self::$console->println("~    | |_| |__   ___    __ _  __ _ _ __ ___   ___| |                         ~");
                self::$console->println("~    | __| '_ \ / _ \  / _` |/ _` | '_ ` _ \ / _ \ |                         ~");
                self::$console->println("~    | |_| | | |  __/ | (_| | (_| | | | | | |  __/_|                         ~");
                self::$console->println("~     \__|_| |_|\___|  \__, |\__,_|_| |_| |_|\___|_|                         ~");
                self::$console->println("~                      |___/                                                 ~");
                self::$console->println("~                                                                            ~");
                self::$console->println("~                                                                            ~");
                self::$console->println("~                                                                            ~");
                self::$console->println("~                   CONGRATULATIONS!                                         ~");
                self::$console->println("~      YOU'VE SHIPPED YOUR VICTORY AND DEVELOPED                             ~");
                self::$console->println("~                  A WINNING STRATEGY.                                       ~");
                self::$console->println("~                                                                            ~");
                self::$console->println("~                                                                            ~");
                self::$console->println("~                                                                            ~");
                self::$console->println("~                       ____                                                 ~");
                self::$console->println("~                        ---|                                                ~");
                self::$console->println("~            \/            /|     \/                                         ~");
                self::$console->println("~                         / |\                                               ~");
                self::$console->println("~                        /  | \        \/                                    ~");
                ...
                self::$console->println("~                   /       ||     \                                         ~");
                self::$console->println("~                  /        /       \                                        ~");
                self::$console->println("~                 /________/         \                                       ~");
                self::$console->println("~                 ________/__________--/                                     ~");
                self::$console->println("~           ~~~   \___________________/                                      ~");
                self::$console->println("~                   ~~~~~~~~~~       ~~~~~~~~                                ~");
                self::$console->println("~          ~~~~~~~~~~~~~     ~~~~~~~~~                                       ~");
                self::$console->println("~                                       ~~~~~~~~~                            ~");
                self::$console->println("~                                                                            ~");
